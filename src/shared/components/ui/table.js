...
/**
 * Table primitives. `Table` brings its own horizontal scroll container because
 * every dashboard table needs one on a narrow viewport and forgetting it is how
 * a page ends up with a horizontally clipped row.
 */
