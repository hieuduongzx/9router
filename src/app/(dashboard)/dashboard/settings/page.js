      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          ...
          <div className="flex flex-col gap-4 mt-4">
            <p className="text-xs sm:text-sm text-text-muted">
              Use Authentik or any OIDC provider to sign in to the dashboard. You can enable account-only, OIDC-only, or both; model API access still uses API keys.
            </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                {[
                  ...
                  },
                  {
                    value: "both",
                    title: "Both",
                    desc: "Allow either an account or OIDC.",
                  },
                ].map((option) => {
            ...
            {settings.authMode === "oidc" && (
              <p className="text-xs sm:text-sm text-amber-600 dark:text-amber-400">
                OIDC login is currently active. Account login and registration are disabled until you switch back.
              </p>
            )}

            {settings.authMode === "both" && (
              <p className="text-xs sm:text-sm text-amber-600 dark:text-amber-400">
                Account and OIDC login are both active.
              </p>
            )}
          </div>
          )}
