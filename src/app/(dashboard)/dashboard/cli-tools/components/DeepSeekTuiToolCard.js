              ...
              <div className="flex flex-col gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Install via npm:</p>
                    <div className="mt-2">
                      <TerminalBlock command="npm install -g deepseek-tui" />
                    </div>
                  ...
                  <div className="flex flex-col gap-2 mb-2">
                    {tool.notes.map((note, idx) => (
                      <div key={idx} className={`flex items-start gap-2 p-2 rounded text-xs ${
                        ...
                        note.type === "error" ? "bg-destructive/10 text-destructive dark:text-destructive" :
                        "bg-info/10 text-info dark:text-info"
                      }`}>
                        <Icon name={note.type === "warning" ? "warning" : note.type === "error" ? "error" : "info"} className="size-[14px] mt-0.5" />
                        <span>{note.text}</span>
                      </div>
                    ))}
                  </div>
